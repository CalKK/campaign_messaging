        ...
        <div className="col-md-8">
          <div className="card">
            ...
            <p className="card-text">
                Upload an Excel file (.xls or .xlsx) with two columns: <strong>name</strong> (Column A) and <strong>telephone</strong> (Column B) to clean your file. Download the cleaned file, refresh the page, re-upload it and click the "generate links" button for the messages that route to WhatsApp. 
              </p>
